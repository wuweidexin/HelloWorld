...
public abstract class RSACoder extends Coder {
	...
	private static final String PUBK_VAL = "icyzicyz";
	private static final String PRIK_VAL = "icyz2015";
	...
	public static String getPrivateKey()
			throws Exception {
		return getClassPathFile("private.key");
	}
	...
	public static String getPublicKey()
		...
		return getClassPathFile("public.key");
	}
	/**
	 * 初始化密钥
	 * 
